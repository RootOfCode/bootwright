...
(let* ((root (make-pathname :name nil :type nil :defaults (or *load-truename*
  ...
  (let ((builder (symbol-function (find-symbol "BUILD-OS-SOURCE-FILE" "BOOTWRIGHT"))))
    (dolist (spec '(("examples/basics/demo-real.bwo"         "out/basics/bootwright-demo.img")
                    ...
                    ("examples/basics/demo-scroll.bwo"       "out/basics/bootwright-scroll.img")
                    ("examples/personality/demo-personality.bwo" "out/personality/bootwright-personality.img")
                    ("examples/lisp-os/demo-lisp-os.bwo"        "out/lisp-os/bootwright-lisp-os.img")
                    ("examples/protected/demo-protected.bwo" "out/protected/bootwright-protected.img")
                    ("examples/protected/demo-paging.bwo"    "out/protected/bootwright-paging.img")
                    ...
                    ("examples/cpu/demo-runtime-utils.bwo"   "out/cpu/bootwright-runtime-utils.img")
